            ...
            <div className="lg:col-span-2">
              ...
              >
                ...
                <div className="mt-6">
                  ...
                  >
                    {r.dash_changeLocRates}
                  </button>
                  <p className="mt-2 text-xs text-slate-500">
                    {r.dash_locMeta} {location} • ×{cityRates?.locationMultiplier}
                  </p>
                </div>
                ...
                >
                  {isAnalyzing ? (
                    ...
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <span>{r.dash_startAi}</span>
                    </div>
                  )}
                </motion.button>
                {isAnalyzing && (
                  <div className="mt-3 flex items-center justify-center gap-2 rounded-lg border border-blue-200 bg-blue-50 px-4 py-2 text-sm text-blue-700">
                ...
                {analysisError && (
                  <motion.div
                    className="mt-4 rounded-xl border border-blue-200 bg-blue-50/90 p-4 text-left"
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0">
                        <p className="text-sm font-semibold text-blue-900">AI Analysis Unavailable</p>
                        <p className="mt-1 text-sm text-blue-800">
                          The analysis service is temporarily unavailable.
                        </p>
                        <p className="mt-1 text-sm text-blue-700">{analysisError}</p>
                        <button
                          type="button"
                          onClick={handleAnalyze}
                          disabled={isAnalyzing || !selectedFile}
                          className="mt-3 inline-flex items-center gap-2 rounded-lg border border-blue-300 bg-white px-3 py-2 text-sm font-medium text-blue-700 transition-colors hover:bg-blue-100 disabled:cursor-not-allowed disabled:opacity-60"
                        >
                          Retry
                        </button>
                      </div>
            ...
            <div className="space-y-6">
              ...
              >
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <h3 className="text-[16px] font-semibold text-[#0F172A]">{r.dash_sysPerf}</h3>
                </div>
                
                <div className="space-y-4">
                  <div className="pb-4 border-b border-slate-100">
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-slate-600">{r.dash_analyzerStatus}</span>
                      <span className="text-lg font-semibold text-[#0F172A]">
                        {isAnalyzing ? r.dash_running : r.dash_ready}
                      </span>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-slate-600">{r.dash_currentFile}</span>
                      <span className="text-sm font-semibold text-[#0F172A] truncate max-w-[140px]">
                        {selectedFile?.name ?? r.dash_notSelected}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-[16px] font-semibold">{r.dash_quickFacts}</h3>
                </div>
                <ul className="space-y-3 text-sm text-blue-50">
                  <li className="flex items-start gap-2">
                    <span className="text-blue-200 mt-0.5">•</span>
                    <span>{r.dash_qf1}</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-200 mt-0.5">•</span>
                    <span>{r.dash_qf2}</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-200 mt-0.5">•</span>
                    <span>{r.dash_qf3}</span>
                  </li>
                </ul>
              </motion.div>
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-medium text-amber-900 mb-1">{r.dash_bestPractices}</p>
                    <p className="text-xs text-amber-700 leading-relaxed">
                      {r.dash_bestPracticesBody}
                    </p>
                  </div>
                </div>
              </motion.div>
