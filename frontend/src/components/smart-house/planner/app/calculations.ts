...
export function calculateFloodSafety(risks: RiskAssessment, _inputs: FormInputs): FloodSafety {
...
// Earthquake safety
export function calculateEarthquakeSafety(risks: RiskAssessment, _inputs: FormInputs): EarthquakeSafety {
