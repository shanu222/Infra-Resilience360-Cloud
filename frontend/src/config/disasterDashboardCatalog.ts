/**
 * Static Disaster Dashboard UX Flow catalog — source of truth for UI data.
 * Media URLs point at resilience360 S3 (no CMS / Mongo / proxy).
 */
import { disasterDashboardCardImageUrl } from './disasterDashboardMedia'
...
export interface Disaster {
  ...
  guidance: Guidance
  color: string
  /** S3 card/detail media (direct URL, no CMS resolver). */
  imageUrl: string
}

export const DISASTER_DASHBOARD_DISASTERS: Disaster[] = [
  {
    id: 'flood',
    name: 'Flood',
    icon: 'waves',
    description:
      'Overflow of water that submerges land, commonly caused by heavy rainfall, river overflow, or dam failure in Pakistan.',
    timeline: [
    ...
    color: 'bg-blue-500',
    imageUrl: disasterDashboardCardImageUrl('flood'),
  },
  {
    id: 'earthquake',
    name: 'Earthquake',
    icon: 'activity',
    description:
      'Ground shaking caused by tectonic plate movements. Pakistan lies in a seismically active zone with frequent tremors.',
    timeline: [
    ...
    color: 'bg-amber-600',
    imageUrl: disasterDashboardCardImageUrl('earthquake'),
  },
  {
    id: 'urban-fire',
    name: 'Urban Fire',
    icon: 'flame',
    description:
      'Fires occurring in residential and commercial areas, often caused by electrical faults, gas leaks, or negligence in urban Pakistan.',
    timeline: [
    ...
    color: 'bg-red-500',
    imageUrl: disasterDashboardCardImageUrl('urban-fire'),
  },
  {
    id: 'crop-fire',
    name: 'Crop Fire',
    icon: 'wheat',
    description:
      'Agricultural fires affecting farmland, often due to stubble burning or dry conditions in Punjab and Sindh provinces.',
    timeline: [
    ...
    color: 'bg-orange-500',
    imageUrl: disasterDashboardCardImageUrl('crop-fire'),
  },
  {
    id: 'heatwave',
    name: 'Heatwave',
    icon: 'sun',
    description:
      'Prolonged periods of extreme heat, particularly dangerous in Sindh and Punjab regions with temperatures exceeding 45°C.',
    timeline: [
    ...
    color: 'bg-yellow-500',
    imageUrl: disasterDashboardCardImageUrl('heatwave'),
  },
  {
    id: 'load-shedding',
    name: 'Load Shedding',
    icon: 'zap-off',
    description:
      'Planned or emergency power cuts affecting daily life, businesses, and essential services across Pakistan.',
    timeline: [
    ...
    color: 'bg-purple-500',
    imageUrl: disasterDashboardCardImageUrl('load-shedding'),
  },
  {
    id: 'storm-cyclone',
    name: 'Storm / Cyclone',
    ...
    description:
      'Tropical cyclones and severe storms affecting coastal areas of Sindh and Balochistan, bringing heavy rain and strong winds.',
    timeline: [
    ...
    color: 'bg-indigo-500',
    imageUrl: disasterDashboardCardImageUrl('storm-cyclone'),
  },
  {
    id: 'landslide',
    name: 'Landslide',
    icon: 'mountain',
    description:
      'Slope failures in hilly areas of KPK, Kashmir, and Gilgit-Baltistan, triggered by heavy rainfall or earthquakes.',
    timeline: [
    ...
    color: 'bg-stone-600',
    imageUrl: disasterDashboardCardImageUrl('landslide'),
  },
  {
    id: 'cold-wave',
    name: 'Cold Wave',
    icon: 'snowflake',
    description:
      'Severe cold weather affecting northern regions and upper Pakistan, causing health issues and disrupting daily life.',
    timeline: [
    ...
    color: 'bg-cyan-500',
    imageUrl: disasterDashboardCardImageUrl('cold-wave'),
  },
  {
    id: 'smog',
    name: 'Smog',
    icon: 'wind',
    description:
      'Severe air pollution creating hazardous smog in major cities like Lahore and Karachi, affecting health and visibility.',
    timeline: [
    ...
    color: 'bg-gray-500',
    imageUrl: disasterDashboardCardImageUrl('smog'),
  },
]

export type DisasterDashboardHazard = {
  id: string
  title: string
  summary: string
  imageUrl: string
...
/** Legacy hazard list shape — derived from static catalog (no CMS). */
export const DISASTER_DASHBOARD_HAZARDS: DisasterDashboardHazard[] = DISASTER_DASHBOARD_DISASTERS.map(
  (d) => ({
    id: d.id,
    title: d.name,
